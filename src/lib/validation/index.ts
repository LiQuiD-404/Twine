...
export const ProfileValidation = z.object({
  ...
  followers: z.array(z.string()), // Example: Assuming followers are stored as an array of user IDs
  following: z.array(z.string()), // Example: Assuming following are stored as an array of user IDs
});
